...
Section SIM.
  ...
  Lemma fn_has_spec_impl fn arg_src arg_tgt pre0 post0 pre1 post1
        (PRE: bi_entails pre1 (#=> pre0))
        (POST: forall ret_src ret_tgt, bi_entails (post0 ret_src ret_tgt) (#=> (post1 ret_src ret_tgt)))
        (SPEC: fn_has_spec fn arg_src arg_tgt pre0 post0)
    :
      fn_has_spec fn arg_src arg_tgt pre1 post1.
  Proof.
  ...
  Program Definition isim'
    ...
    iProp_intro (fun res => gpaco8 (_hsim) (cpn8 _hsim) r g _ _ Q res f_src f_tgt st_src st_tgt) _.
  Next Obligation.
  ...
  Definition isim
             ...
             (st_src: Any.t * itree Es' R_src)
             (st_tgt: Any.t * itree Es R_tgt): iProp :=
    isim' r g f_src f_tgt Q st_src st_tgt.

  Lemma isim_init
        R_src R_tgt (Q: Any.t -> Any.t -> R_src -> R_tgt -> iProp)
        P r g fmr f_src f_tgt st_src st_tgt itr_src itr_tgt
        (ENTAIL: bi_entails
                   P
                   (isim (r, g, f_src, f_tgt) Q (st_src, itr_src) (st_tgt, itr_tgt)))
        (CUR: current_iProp fmr P)
    :
      gpaco8 _hsim (cpn8 _hsim) r g _ _ Q fmr f_src f_tgt (st_src, itr_src) (st_tgt, itr_tgt).
  Proof.
  ...
  Lemma isim_final
        R_src R_tgt (Q: Any.t -> Any.t -> R_src -> R_tgt -> iProp)
        P r g f_src f_tgt st_src st_tgt itr_src itr_tgt
        (SIM: forall fmr
                     (CUR: current_iProp fmr P),
            gpaco8 _hsim (cpn8 _hsim) r g _ _ Q fmr f_src f_tgt (st_src, itr_src) (st_tgt, itr_tgt))
    :
  ...
  Lemma isim_current
        R_src R_tgt (Q: Any.t -> Any.t -> R_src -> R_tgt -> iProp)
        r g fmr f_src f_tgt st_src st_tgt itr_src itr_tgt
        (CUR: current_iProp fmr (isim (r, g, f_src, f_tgt) Q (st_src, itr_src) (st_tgt, itr_tgt)))
    :
      gpaco8 _hsim (cpn8 _hsim) r g _ _ Q fmr f_src f_tgt (st_src, itr_src) (st_tgt, itr_tgt).
  Proof.
  ...
  Lemma isim_upd R_src R_tgt
    ...
    :
      bi_entails
        (#=> (isim (r, g, f_src, f_tgt) (fun st_src st_tgt ret_src ret_tgt => #=> Q st_src st_tgt ret_src ret_tgt) st_src st_tgt))
        (isim (r, g, f_src, f_tgt) Q st_src st_tgt).
  Proof.
  ...
  Lemma isim_mono R_src R_tgt
    ...
    :
      bi_entails
        (isim (r, g, f_src, f_tgt) Q0 (st_src, itr_src) (st_tgt, itr_tgt))
        (isim (r, g, f_src, f_tgt) Q1 (st_src, itr_src) (st_tgt, itr_tgt)).
  Proof.
    red. unfold Entails. autorewrite with iprop.
    unfold isim in *. i.
    ss.
    ...
    :
      bi_entails
        ((∀ st_src st_tgt ret_src ret_tgt,
             ((Q0 st_src st_tgt ret_src ret_tgt) -∗ (Q1 st_src st_tgt ret_src ret_tgt))) ** (isim (r, g, f_src, f_tgt) Q0 (st_src, itr_src) (st_tgt, itr_tgt)))
        (isim (r, g, f_src, f_tgt) Q1 (st_src, itr_src) (st_tgt, itr_tgt)).
  Proof.
    red. unfold Entails. autorewrite with iprop.
  ...
  Lemma isim_bind R_src R_tgt S_src S_tgt
    ...
    :
      bi_entails
        (isim (r, g, f_src, f_tgt) (fun st_src st_tgt ret_src ret_tgt => isim (r, g, false, false) Q (st_src, ktr_src ret_src) (st_tgt, ktr_tgt ret_tgt)) (st_src, itr_src) (st_tgt, itr_tgt))
        (isim (r, g, f_src, f_tgt) Q (st_src, itr_src >>= ktr_src) (st_tgt, itr_tgt >>= ktr_tgt)).
  Proof.
    red. unfold Entails. autorewrite with iprop.
    unfold isim in *. i.
  ...
  Lemma isim_bind_left R_src R_tgt S_src
    ...
    :
      bi_entails
        (isim (r, g, f_src, f_tgt) (fun st_src st_tgt ret_src ret_tgt => isim (r, g, false, false) Q (st_src, ktr_src ret_src) (st_tgt, itr_tgt)) (st_src, itr_src) (st_tgt, Ret tt))
        (isim (r, g, f_src, f_tgt) Q (st_src, itr_src >>= ktr_src) (st_tgt, itr_tgt)).
  Proof.
    iIntros "H".
  ...
  Lemma isim_bind_right R_src R_tgt S_tgt
    ...
    :
      bi_entails
        (isim (r, g, f_src, f_tgt) (fun st_src st_tgt ret_src ret_tgt => isim (r, g, false, false) Q (st_src, itr_src) (st_tgt, ktr_tgt ret_tgt)) (st_src, Ret tt) (st_tgt, itr_tgt))
        (isim (r, g, f_src, f_tgt) Q (st_src, itr_src) (st_tgt, itr_tgt >>= ktr_tgt)).
  Proof.
    iIntros "H".
  ...
  Lemma isim_call_impure
        ...
        (SPEC: fn_has_spec fn arg_src arg_tgt pre post)
        P
        (PREMISE: P ⊢ ((I w0 st_src st_tgt)
           ** (pre: iProp)
           ** (∀ st_src st_tgt ret_src ret_tgt,
                  {{"INV": inv_with le I w0 st_src st_tgt}} -* {{"POST": (post ret_src ret_tgt: iProp)}} -* isim (g, g, true, true) Q (st_src, ktr_src ret_src) (st_tgt, ktr_tgt ret_tgt))))
    :
      bi_entails
        P
        (isim (r, g, f_src, f_tgt) Q (st_src, trigger (Call fn arg_src) >>= ktr_src) (st_tgt, trigger (Call fn arg_tgt) >>= ktr_tgt)).
  Proof.
    red. unfold Entails. autorewrite with iprop.
    unfold isim, isim'. rr. i.
    match (type of H) with
    | (iProp_pred ?P) _ =>
      assert (CUR: current_iProp r0 P)
    end.
    { econs; eauto. refl. }
    eapply current_iProp_entail in CUR; try apply PREMISE; clear PREMISE.
    ...
    { iApply (POST with "A"). }
    mUpd "A2".
    mAssert (isim (g, g, true, true) Q (st_src1, ktr_src ret_src)
  ...
  Lemma isim_progress R_src R_tgt
    ...
    :
      bi_entails
        (isim (g, g, false, false) Q (st_src, itr_src) (st_tgt, itr_tgt))
        (isim (r, g, true, true) Q (st_src, itr_src) (st_tgt, itr_tgt)).
  Proof.
  ...
  Lemma isim_knowledge_mon
    ...
    :
      bi_entails
        (isim (r0, g0, f_src, f_tgt) Q (st_src, itr_src) (st_tgt, itr_tgt))
        (isim (r1, g1, f_src, f_tgt) Q (st_src, itr_src) (st_tgt, itr_tgt)).
  Proof.
    eapply isim_final. i. eapply isim_current in CUR.
    eapply gpaco8_mon; eauto.
  Qed.
  ...
  Lemma isim_flag_mon
    ...
    :
      bi_entails
        (isim (r, g, f_src0, f_tgt0) Q (st_src, itr_src) (st_tgt, itr_tgt))
        (isim (r, g, f_src1, f_tgt1) Q (st_src, itr_src) (st_tgt, itr_tgt)).
  Proof.
    eapply isim_final. i. eapply isim_current in CUR.
  ...
  Lemma isim_split
    ...
    :
      bi_entails
        (isim (r, g, f_src, f_tgt) (fun st_src st_tgt _ ret_tgt => isim (r, g, false, false) Q (st_src, itr_src) (st_tgt, ktr_tgt ret_tgt)) (st_src, Ret tt) (st_tgt, itr_tgt))
        (isim (r, g, f_src, f_tgt) Q (st_src, itr_src) (st_tgt, itr_tgt >>= ktr_tgt)).
  Proof.
    iIntros "H".
  ...
  Lemma isim_ret
    ...
    :
      bi_entails
        ...
        (isim (r, g, f_src, f_tgt) Q (st_src, Ret v_src) (st_tgt, (Ret v_tgt))).
  Proof.
    eapply isim_final. i.
  ...
  Lemma isim_call_impure_trigger
    ...
    :
      bi_entails
        ...
        (isim (r, g, f_src, f_tgt) Q (st_src, trigger (Call fn arg_src)) (st_tgt, trigger (Call fn arg_tgt))).
  Proof.
  ...
  Global Instance iProp_isim_absorbing
    ...
    Absorbing (isim (r, g, f_src, f_tgt) Q st_src st_tgt).
  Proof.
  ...
  Global Instance iProp_isim_elim_upd
         ...
         f_src f_tgt st_src st_tgt
         P:
    ElimModal True false false (#=> P) P (isim (r, g, f_src, f_tgt) Q st_src st_tgt) (isim (r, g, f_src, f_tgt) Q st_src st_tgt).
  Proof.
  ...
  Lemma isim_syscall
    ...
    :
      bi_entails
        (∀ ret, isim (g, g, true, true) Q (st_src, ktr_src ret) (st_tgt, ktr_tgt ret))
        (isim (r, g, f_src, f_tgt) Q (st_src, trigger (Syscall fn arg rvs) >>= ktr_src) (st_tgt, trigger (Syscall fn arg rvs) >>= ktr_tgt)).
  Proof.
  ...
  Lemma isim_syscall_trigger
    ...
    :
      bi_entails
        ...
        (isim (r, g, f_src, f_tgt) Q (st_src, trigger (Syscall fn arg_src rvs)) (st_tgt, trigger (Syscall fn arg_tgt rvs))).
  Proof.
  ...
  Lemma isim_tau_src
    ...
    :
      bi_entails
        (isim (r, g, true, f_tgt) Q (st_src, itr_src) (st_tgt, itr_tgt))
        (isim (r, g, f_src, f_tgt) Q (st_src, tau;; itr_src) (st_tgt, itr_tgt)).
  Proof.
    eapply isim_final. i. eapply hsimC_uclo. econs; eauto.
  ...
  Lemma isim_tau_tgt
    ...
    :
      bi_entails
        (isim (r, g, f_src, true) Q (st_src, itr_src) (st_tgt, itr_tgt))
        (isim (r, g, f_src, f_tgt) Q (st_src, itr_src) (st_tgt, tau;; itr_tgt)).
  Proof.
    eapply isim_final. i. eapply hsimC_uclo. econs; eauto.
    eapply isim_current; eauto.
  Qed.
  ...
  Lemma isim_choose_src
    ...
    :
      bi_entails
        (∃ x, isim (r, g, true, f_tgt) Q (st_src, ktr_src x) (st_tgt, itr_tgt))
        (isim (r, g, f_src, f_tgt) Q (st_src, trigger (Choose X) >>= ktr_src) (st_tgt, itr_tgt)).
  Proof.
    eapply isim_final. i. eapply hsimC_uclo. econs; eauto.
  ...
  Lemma isim_choose_src_trigger
    ...
    :
      bi_entails
        (∃ x, isim (r, g, true, f_tgt) Q (st_src, Ret x) (st_tgt, itr_tgt))
        (isim (r, g, f_src, f_tgt) Q (st_src, trigger (Choose X)) (st_tgt, itr_tgt)).
  Proof.
  ...
  Lemma isim_choose_tgt
    ...
    :
      bi_entails
        (∀ x, isim (r, g, f_src, true) Q (st_src, itr_src) (st_tgt, ktr_tgt x))
        (isim (r, g, f_src, f_tgt) Q (st_src, itr_src) (st_tgt, trigger (Choose X) >>= ktr_tgt)).
  Proof.
    eapply isim_final. i. eapply hsimC_uclo. econs; eauto.
  ...
  Lemma isim_choose_tgt_trigger
    ...
    :
      bi_entails
        (∀ x, isim (r, g, f_src, true) Q (st_src, itr_src) (st_tgt, Ret x))
        (isim (r, g, f_src, f_tgt) Q (st_src, itr_src) (st_tgt, trigger (Choose X))).
  Proof.
    erewrite (@idK_spec _ _ (trigger (Choose X))).
  ...
  Lemma isim_take_src
    ...
    :
      bi_entails
        (∀ x, isim (r, g, true, f_tgt) Q (st_src, ktr_src x) (st_tgt, itr_tgt))
        (isim (r, g, f_src, f_tgt) Q (st_src, trigger (Take X) >>= ktr_src) (st_tgt, itr_tgt)).
  Proof.
    eapply isim_final. i. eapply hsimC_uclo. econs; eauto.
    inv CUR. rr in IPROP. uipropall. i. guclo hupdC_spec. econs; eauto.
  Qed.
  ...
  Lemma isim_take_src_trigger
    ...
    :
      bi_entails
        (∀ x, isim (r, g, true, f_tgt) Q (st_src, Ret x) (st_tgt, itr_tgt))
        (isim (r, g, f_src, f_tgt) Q (st_src, trigger (Take X)) (st_tgt, itr_tgt)).
  Proof.
  ...
  Lemma isim_take_tgt
    ...
    :
      bi_entails
        (∃ x, isim (r, g, f_src, true) Q (st_src, itr_src) (st_tgt, ktr_tgt x))
        (isim (r, g, f_src, f_tgt) Q (st_src, itr_src) (st_tgt, trigger (Take X) >>= ktr_tgt)).
  Proof.
    eapply isim_final. i. eapply hsimC_uclo. econs; eauto.
    inv CUR. rr in IPROP. uipropall. des. esplits. guclo hupdC_spec. econs; eauto.
  Qed.
  ...
  Lemma isim_take_tgt_trigger
    ...
    :
      bi_entails
        (∃ x, isim (r, g, f_src, true) Q (st_src, itr_src) (st_tgt, Ret x))
        (isim (r, g, f_src, f_tgt) Q (st_src, itr_src) (st_tgt, trigger (Take X))).
  Proof.
    erewrite (@idK_spec _ _ (trigger (Take X))).
  ...
  Lemma isim_pput_src
    ...
    :
      bi_entails
        (isim (r, g, true, f_tgt) Q (st_src1, ktr_src tt) (st_tgt, itr_tgt))
        (isim (r, g, f_src, f_tgt) Q (st_src0, trigger (PPut st_src1) >>= ktr_src) (st_tgt, itr_tgt)).
  Proof.
    eapply isim_final. i. eapply hsimC_uclo. econs; eauto.
    eapply isim_current; eauto.
  Qed.
  ...
  Lemma isim_pput_src_trigger
    ...
    :
      bi_entails
        (isim (r, g, true, f_tgt) Q (st_src1, Ret tt) (st_tgt, itr_tgt))
        (isim (r, g, f_src, f_tgt) Q (st_src0, trigger (PPut st_src1)) (st_tgt, itr_tgt)).
  Proof.
  ...
  Lemma isim_pget_src
    ...
    :
      bi_entails
        (isim (r, g, true, f_tgt) Q (st_src, ktr_src st_src) (st_tgt, itr_tgt))
        (isim (r, g, f_src, f_tgt) Q (st_src, trigger (PGet) >>= ktr_src) (st_tgt, itr_tgt)).
  Proof.
    eapply isim_final. i. eapply hsimC_uclo. econs; eauto.
    eapply isim_current; eauto.
  Qed.
  ...
  Lemma isim_get_src_trigger
    ...
    :
      bi_entails
        (isim (r, g, true, f_tgt) Q (st_src, Ret st_src) (st_tgt, itr_tgt))
        (isim (r, g, f_src, f_tgt) Q (st_src, trigger (PGet)) (st_tgt, itr_tgt)).
  Proof.
  ...
  Lemma isim_pput_tgt
    ...
    :
      bi_entails
        (isim (r, g, f_src, true) Q (st_src, itr_src) (st_tgt1, ktr_tgt tt))
        (isim (r, g, f_src, f_tgt) Q (st_src, itr_src) (st_tgt0, trigger (PPut st_tgt1) >>= ktr_tgt)).
  Proof.
    eapply isim_final. i. eapply hsimC_uclo. econs; eauto.
    eapply isim_current; eauto.
  Qed.
  ...
  Lemma isim_pput_tgt_trigger
    ...
    :
      bi_entails
        (isim (r, g, f_src, true) Q (st_src, itr_src) (st_tgt1, Ret tt))
        (isim (r, g, f_src, f_tgt) Q (st_src, itr_src) (st_tgt0, trigger (PPut st_tgt1))).
  Proof.
  ...
  Lemma isim_pget_tgt
    ...
    :
      bi_entails
        (isim (r, g, f_src, true) Q (st_src, itr_src) (st_tgt, ktr_tgt st_tgt))
        (isim (r, g, f_src, f_tgt) Q (st_src, itr_src) (st_tgt, trigger (PGet) >>= ktr_tgt)).
  Proof.
    eapply isim_final. i. eapply hsimC_uclo. econs; eauto.
    eapply isim_current; eauto.
  Qed.
  ...
  Lemma isim_pget_tgt_trigger
    ...
    :
      bi_entails
        (isim (r, g, f_src, true) Q (st_src, itr_src) (st_tgt, Ret st_tgt))
        (isim (r, g, f_src, f_tgt) Q (st_src, itr_src) (st_tgt, trigger (PGet))).
  Proof.
    erewrite (@idK_spec _ _ (trigger (PGet))).
  ...
  Lemma isim_assume_src
    ...
    :
      bi_entails
        (⌜P⌝ -* isim (r, g, true, f_tgt) Q (st_src, k_src tt) (st_tgt, i_tgt))
        (isim (r, g, f_src, f_tgt) Q (st_src, assume P >>= k_src) (st_tgt, i_tgt)).
  Proof.
  ...
  Lemma isim_assume_src_trigger
    ...
    :
      bi_entails
        (⌜P⌝ -* isim (r, g, true, f_tgt) Q (st_src, Ret tt) (st_tgt, itr_tgt))
        (isim (r, g, f_src, f_tgt) Q (st_src, assume P) (st_tgt, itr_tgt)).
  Proof.
  ...
  Lemma isim_assume_tgt
    ...
    :
      bi_entails
        (⌜P⌝ ∧ isim (r, g, f_src, true) Q (st_src, itr_src) (st_tgt, ktr_tgt tt))
        (isim (r, g, f_src, f_tgt) Q (st_src, itr_src) (st_tgt, assume P >>= ktr_tgt)).
  Proof.
  ...
  Lemma isim_assume_tgt_trigger
    ...
    :
      bi_entails
        (⌜P⌝ ∧ isim (r, g, f_src, true) Q (st_src, itr_src) (st_tgt, Ret tt))
        (isim (r, g, f_src, f_tgt) Q (st_src, itr_src) (st_tgt, assume P)).
  Proof.
    erewrite (@idK_spec _ _ (assume P)).
  ...
  Lemma isim_guarantee_src
    ...
    :
      bi_entails
        (⌜P⌝ ∧ isim (r, g, true, f_tgt) Q (st_src, ktr_src tt) (st_tgt, itr_tgt))
        (isim (r, g, f_src, f_tgt) Q (st_src, guarantee P >>= ktr_src) (st_tgt, itr_tgt)).
  Proof.
    iIntros "H". iDestruct "H" as "[% H]".
  ...
  Lemma isim_guarantee_src_trigger
    ...
    :
      bi_entails
        (⌜P⌝ ∧ isim (r, g, true, f_tgt) Q (st_src, Ret tt) (st_tgt, itr_tgt))
        (isim (r, g, f_src, f_tgt) Q (st_src, guarantee P) (st_tgt, itr_tgt)).
  Proof.
  ...
  Lemma isim_guarantee_tgt
    ...
    :
      bi_entails
        (⌜P⌝ -* isim (r, g, f_src, true) Q (st_src, itr_src) (st_tgt, ktr_tgt tt))
        (isim (r, g, f_src, f_tgt) Q (st_src, itr_src) (st_tgt, guarantee P >>= ktr_tgt)).
  Proof.
  ...
  Lemma isim_guarantee_tgt_trigger
    ...
    :
      bi_entails
        (⌜P⌝ -* isim (r, g, f_src, true) Q (st_src, itr_src) (st_tgt, Ret tt))
        (isim (r, g, f_src, f_tgt) Q (st_src, itr_src) (st_tgt, guarantee P)).
  Proof.
    erewrite (@idK_spec _ _ (guarantee P)).
  ...
  Lemma isim_triggerUB_src
    ...
    :
      bi_entails
        (⌜True⌝)
        (isim (r, g, f_src, f_tgt) Q (st_src, triggerUB >>= ktr_src) (st_tgt, itr_tgt)).
  Proof.
  ...
  Lemma isim_triggerUB_src_trigger
    ...
    :
      bi_entails
        (⌜True⌝)
        (isim (r, g, f_src, f_tgt) Q (st_src, triggerUB) (st_tgt, itr_tgt)).
  Proof.
  ...
  Lemma isim_triggerNB_tgt
    ...
    :
      bi_entails
        (⌜True⌝)
        (isim (r, g, f_src, f_tgt) Q (st_src, itr_src) (st_tgt, triggerNB >>= ktr_tgt)).
  Proof.
  ...
  Lemma isim_triggerNB_trigger
    ...
    :
      bi_entails
        (⌜True⌝)
        (isim (r, g, f_src, f_tgt) Q (st_src, itr_src) (st_tgt, triggerNB)).
  Proof.
  ...
  Lemma isim_unwrapU_src
    ...
    :
      bi_entails
        (∀ x', ⌜x = Some x'⌝ -* isim (r, g, f_src, f_tgt) Q (st_src, ktr_src x') (st_tgt, itr_tgt))
        (isim (r, g, f_src, f_tgt) Q (st_src, unwrapU x >>= ktr_src) (st_tgt, itr_tgt)).
  Proof.
  ...
  Lemma isim_unwrapU_src_trigger
    ...
    :
      bi_entails
        (∀ x', ⌜x = Some x'⌝ -* isim (r, g, f_src, f_tgt) Q (st_src, Ret x') (st_tgt, itr_tgt))
        (isim (r, g, f_src, f_tgt) Q (st_src, unwrapU x) (st_tgt, itr_tgt)).
  Proof.
  ...
  Lemma isim_unwrapN_src
    ...
    :
      bi_entails
        (∃ x', ⌜x = Some x'⌝ ∧ isim (r, g, f_src, f_tgt) Q (st_src, ktr_src x') (st_tgt, itr_tgt))
        (isim (r, g, f_src, f_tgt) Q (st_src, unwrapN x >>= ktr_src) (st_tgt, itr_tgt)).
  Proof.
  ...
  Lemma isim_unwrapN_src_trigger
    ...
    :
      bi_entails
        (∃ x', ⌜x = Some x'⌝ ∧ isim (r, g, f_src, f_tgt) Q (st_src, Ret x') (st_tgt, itr_tgt))
        (isim (r, g, f_src, f_tgt) Q (st_src, unwrapN x) (st_tgt, itr_tgt)).
  Proof.
  ...
  Lemma isim_unwrapU_tgt
    ...
    :
      bi_entails
        (∃ x', ⌜x = Some x'⌝ ∧ isim (r, g, f_src, f_tgt) Q (st_src, itr_src) (st_tgt, ktr_tgt x'))
        (isim (r, g, f_src, f_tgt) Q (st_src, itr_src) (st_tgt, unwrapU x >>= ktr_tgt)).
  Proof.
  ...
  Lemma isim_unwrapU_tgt_trigger
    ...
    :
      bi_entails
        (∃ x', ⌜x = Some x'⌝ ∧ isim (r, g, f_src, f_tgt) Q (st_src, itr_src) (st_tgt, Ret x'))
        (isim (r, g, f_src, f_tgt) Q (st_src, itr_src) (st_tgt, unwrapU x)).
  Proof.
    erewrite (@idK_spec _ _ (unwrapU x)).
    iIntros "H". iDestruct "H" as (x') "[% H]".
  ...
  Lemma isim_unwrapN_tgt
    ...
    :
      bi_entails
        (∀ x', ⌜x = Some x'⌝ -* isim (r, g, f_src, f_tgt) Q (st_src, itr_src) (st_tgt, ktr_tgt x'))
        (isim (r, g, f_src, f_tgt) Q (st_src, itr_src) (st_tgt, unwrapN x >>= ktr_tgt)).
  Proof.
  ...
  Lemma isim_unwrapN_tgt_trigger
    ...
    :
      bi_entails
        (∀ x', ⌜x = Some x'⌝ -* isim (r, g, f_src, f_tgt) Q (st_src, itr_src) (st_tgt, Ret x'))
        (isim (r, g, f_src, f_tgt) Q (st_src, itr_src) (st_tgt, unwrapN x)).
  Proof.
    erewrite (@idK_spec _ _ (unwrapN x)).
...
(*     (isim *)
(*        world_le_trivial world_wf_trivial stb *)
(*        (bot8, bot8, false, false) *)
...
(*         w r g f_src f_tgt R Q st_src st_tgt (itr: itree Es R) *)
(*     : *)
(*       bi_entails *)
...
(*         w r g f_src f_tgt Q st_src st_tgt (itr: itree Es Any.t) *)
(*     : *)
(*       bi_entails *)
(*         ((inv_with world_le_trivial world_wf_trivial w st_src st_tgt) *)
(*            ** *)
...
Section ADEQUACY.
  ...
  Lemma isim_fun_to_tgt_aux
        ...
        (ISIM: forall w (x: (stb fn).(meta)) arg_src arg_tgt st_src st_tgt,
            bi_entails
              ((inv_with le wf w st_src st_tgt) ** ((stb fn).(precond) x arg_src arg_tgt: iProp))
              (isim
                 le wf stb
                 (bot8, bot8, true, f_tgt)
                 (fun st_src st_tgt ret_src ret_tgt =>
                    (inv_with le wf w st_src st_tgt) ** ((stb fn).(postcond) x ret_src ret_tgt: iProp))
                 (st_src, body arg_src) (st_tgt, f arg_tgt)))
    :
      sim_itree
        (mk_wf wf) le
        f_src f_tgt
        w
        (st_src, fun_to_tgt stb fn body x) (st_tgt, f y).
  Proof.
    subst.
    ginit. unfold fun_to_tgt. rewrite HoareFun_parse. harg.
    gfinal. right. steps. rp; try eapply hsim_adequacy; eauto.
  ...
  Lemma isim_fun_to_tgt
        ...
        (ISIM: forall w (x: (stb fn).(meta)) arg_src arg_tgt st_src st_tgt,
            bi_entails
              ({{"INV": (inv_with le wf w st_src st_tgt)}} ** {{"PRE": ((stb fn).(precond) x arg_src arg_tgt: iProp)}})
              (isim
                 le wf stb
                 (bot8, bot8, true, false)
                 (fun st_src st_tgt ret_src ret_tgt =>
                    (inv_with le wf w st_src st_tgt) ** ((stb fn).(postcond) x ret_src ret_tgt: iProp))
                 (st_src, body arg_src) (st_tgt, f arg_tgt)))
    :
      sim_fsem (mk_wf wf) le
               (fun_to_tgt stb fn body) f.
  Proof.
