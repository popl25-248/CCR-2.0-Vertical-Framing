...
Section PROOF.
  ...
  Definition MemSbtb: list (gname * (Any.t → itree Es' Any.t)) :=
    [("alloc", (fun _ => trigger (Choose _)));
    ("free",   (fun _ => trigger (Choose _)));
    ("load",   (fun _ => trigger (Choose _)));
    ("store",  (fun _ => trigger (Choose _)));
    ("cmp",    (fun _ => trigger (Choose _)))
    ]
  .
  ...
  Definition Mem: Mod.t := (SMod.to_tgt (fun _ => MemConds)) SMem.
